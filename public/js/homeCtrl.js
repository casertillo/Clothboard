"use strict";
var homeCtrl = angular.module('homeCtrl', ['ngMaterial', 'ngAnimate']);

//SLIDER DIRECTIVE
    homeCtrl.directive('createSlider', slider);
    ...
    homeCtrl.directive('effectSlider', effectsSlider);
...
homeCtrl.controller('homeCtrl', homeFunction);

function homeFunction($scope, $timeout, $mdSidenav, $log, $http, $rootScope, $filter, $routeParams, $location){
    ...
    var user = $filter('filter')(data.users, function (d) {return d._id === $routeParams.profileid;})[0];
    ...
    $scope.homeUser = function(userid)
    {
